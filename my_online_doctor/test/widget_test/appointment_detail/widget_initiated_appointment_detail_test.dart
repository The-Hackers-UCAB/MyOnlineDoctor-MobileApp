...
void main() {
  ...
  testWidgets('El detalle de una cita iniciada no tiene el botón de aceptar cita',
      (tester) async {
    // Arrange
    final appointmentMock = AppointmentExamples.initiatedAppointment();
    // Act
  ...
  testWidgets(
      'El detalle de una cita iniciada no tiene el botón de rechazar cita',
      (tester) async {
    // Arrange
    final appointmentMock = AppointmentExamples.initiatedAppointment();
    // Act
  ...
  testWidgets(
      'El detalle de una cita iniciada no tiene el botón de cancelar cita',
      (tester) async {
    // Arrange
    final appointmentMock = AppointmentExamples.initiatedAppointment();
    // Act
