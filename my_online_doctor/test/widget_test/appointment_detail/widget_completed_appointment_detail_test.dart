...
void main() {
  ...
  testWidgets('El detalle de una cita completada no tiene el botón de aceptar cita',
      (tester) async {
    // Arrange
    final appointmentMock = AppointmentExamples.completedAppointment();
    // Act
  ...
  testWidgets(
      'El detalle de una cita completada no tiene el botón de rechazar cita',
      (tester) async {
    // Arrange
    final appointmentMock = AppointmentExamples.completedAppointment();
    // Act
  ...
  testWidgets(
      'El detalle de una cita completada tiene el botón de cancelar cita',
      (tester) async {
    // Arrange
    final appointmentMock = AppointmentExamples.completedAppointment();
    // Act
