...
void main() {
  ...
  testWidgets('El detalle de una cita agendada tiene el botón de aceptar cita',
      (tester) async {
    // Arrange
    ...
    // Assert
    expect(find.text(TextConstant.acceptAppointment.text), findsOneWidget);
  });

  testWidgets(
      'El detalle de una cita agendada tiene el botón de rechazar cita',
      (tester) async {
    // Arrange
    final appointmentMock = AppointmentExamples.scheduledAppointment();
    // Act
  ...
  testWidgets(
      'El detalle de una cita agendada no tiene el botón de cancelar cita',
      (tester) async {
    // Arrange
    final appointmentMock = AppointmentExamples.scheduledAppointment();
    // Act
