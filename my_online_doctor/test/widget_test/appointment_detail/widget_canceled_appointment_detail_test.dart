...
void main() {
  ...
  testWidgets('El detalle de una cita cancelada no tiene el botón de aceptar cita',
      (tester) async {
    // Arrange
    final appointmentMock = AppointmentExamples.canceledAppointment();
    // Act
  ...
  testWidgets(
      'El detalle de una cita cancelada no tiene el botón de rechazar cita',
      (tester) async {
    // Arrange
    final appointmentMock = AppointmentExamples.canceledAppointment();
    // Act
  ...
  testWidgets(
      'El detalle de una cita cancelada tiene el botón de cancelar cita',
      (tester) async {
    // Arrange
    final appointmentMock = AppointmentExamples.canceledAppointment();
    // Act
