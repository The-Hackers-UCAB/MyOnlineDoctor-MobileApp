...
void main() {
  ...
  testWidgets('El detalle de una cita solicitada no tiene el botón de aceptar cita',
      (tester) async {
    // Arrange
    final appointmentMock = AppointmentExamples.requestedAppointment();
    // Act
  ...
  testWidgets(
      'El detalle de una cita solicitada no tiene el botón de rechazar cita',
      (tester) async {
    // Arrange
    final appointmentMock = AppointmentExamples.requestedAppointment();
    // Act
  ...
  testWidgets(
      'El detalle de una cita solicitada tiene el botón de cancelar cita',
      (tester) async {
    // Arrange
    final appointmentMock = AppointmentExamples.requestedAppointment();
    // Act
