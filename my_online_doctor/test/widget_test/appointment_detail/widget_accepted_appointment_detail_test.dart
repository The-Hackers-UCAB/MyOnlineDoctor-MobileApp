...
void main() {
  ...
  testWidgets('El detalle de una cita aceptada no tiene el botón de aceptar cita',
      (tester) async {
    // Arrange
    final appointmentMock = AppointmentExamples.acceptedAppointment();
    // Act
  ...
  testWidgets(
      'El detalle de una cita aceptada no tiene el botón de rechazar cita',
      (tester) async {
    // Arrange
    final appointmentMock = AppointmentExamples.acceptedAppointment();
    // Act
  ...
  testWidgets(
      'El detalle de una cita aceptada tiene el botón de cancelar cita',
      (tester) async {
    // Arrange
    final appointmentMock = AppointmentExamples.acceptedAppointment();
    // Act
    ...
    // Assert
    expect(find.text(TextConstant.cancelAppointment.text), findsOneWidget);
  });
}
